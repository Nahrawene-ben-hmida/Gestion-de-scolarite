...
let CadresAdminRoutingModule = class CadresAdminRoutingModule {
};
...
let CadresAdminComponent = class CadresAdminComponent {
    constructor(cadresAdminService, formBuilder) {
    ...
    setCadresAdmin() {
        this.cadresAdminService.getAllCadreAdmins().subscribe(cadresAdmins => {
            ...
            this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](this.cadresAdmins);
...
CadresAdminComponent.ctorParameters = () => [
...
let CadresAdminModule = class CadresAdminModule {
};
...
//# sourceMappingURL=demo-cadres-admin-cadres-admin-module-es2015.js.map