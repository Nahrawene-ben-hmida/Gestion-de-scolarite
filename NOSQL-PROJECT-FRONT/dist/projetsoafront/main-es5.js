...
var routes = [
    {
        ...
        children: [
            ...
            {
                path: 'etudiant',
                loadChildren: function () { return Promise.all(/*! import() | demo-etudiant-etudiant-module */[__webpack_require__.e("default~class-class-module~demo-cadres-admin-cadres-admin-module~demo-enseignant-enseignant-module~d~8630d238"), __webpack_require__.e("default~demo-etudiant-etudiant-module~session-session-module"), __webpack_require__.e("default~dash-analytics-dash-analytics-module~demo-etudiant-etudiant-module"), __webpack_require__.e("demo-etudiant-etudiant-module")]).then(__webpack_require__.bind(null, /*! ./demo/etudiant/etudiant.module */ "./src/app/demo/etudiant/etudiant.module.ts")).then(function (m) { return m.EtudiantModule; }); },
                canLoad: [_demo_pages_authentication_authentication_guard__WEBPACK_IMPORTED_MODULE_5__["AuthenticationGuard"]]
            },
            {
                path: 'enseignant',
                loadChildren: function () { return Promise.all(/*! import() | demo-enseignant-enseignant-module */[__webpack_require__.e("default~class-class-module~demo-cadres-admin-cadres-admin-module~demo-enseignant-enseignant-module~d~8630d238"), __webpack_require__.e("common"), __webpack_require__.e("demo-enseignant-enseignant-module")]).then(__webpack_require__.bind(null, /*! ./demo/enseignant/enseignant.module */ "./src/app/demo/enseignant/enseignant.module.ts")).then(function (m) { return m.EnseignantModule; }); },
                canLoad: [_demo_pages_authentication_authentication_guard__WEBPACK_IMPORTED_MODULE_5__["AuthenticationGuard"]]
            },
            {
                path: 'cadres-admin',
                loadChildren: function () { return Promise.all(/*! import() | demo-cadres-admin-cadres-admin-module */[__webpack_require__.e("default~class-class-module~demo-cadres-admin-cadres-admin-module~demo-enseignant-enseignant-module~d~8630d238"), __webpack_require__.e("common"), __webpack_require__.e("demo-cadres-admin-cadres-admin-module")]).then(__webpack_require__.bind(null, /*! ./demo/cadres-admin/cadres-admin.module */ "./src/app/demo/cadres-admin/cadres-admin.module.ts")).then(function (m) { return m.CadresAdminModule; }); },
                canLoad: [_demo_pages_authentication_authentication_guard__WEBPACK_IMPORTED_MODULE_5__["AuthenticationGuard"]]
            },
            {
                path: 'gestion-scolarite',
                loadChildren: function () { return __webpack_require__.e(/*! import() | demo-gestion-scolarite-gestion-scolarite-module */ "demo-gestion-scolarite-gestion-scolarite-module").then(__webpack_require__.bind(null, /*! ./demo/gestion-scolarite/gestion-scolarite.module */ "./src/app/demo/gestion-scolarite/gestion-scolarite.module.ts")).then(function (m) { return m.GestionScolariteModule; }); },
                canLoad: [_demo_pages_authentication_authentication_guard__WEBPACK_IMPORTED_MODULE_5__["AuthenticationGuard"]]
            }
        ],
    },
...
var AuthenticationGuard = /** @class */ (function () {
    function AuthenticationGuard(loginService, router) {
        this.loginService = loginService;
        this.router = router;
    }
    AuthenticationGuard.prototype.canLoad = function (route, segments) {
...
var NavRightComponent = /** @class */ (function () {
    function NavRightComponent(loginService) {
        this.loginService = loginService;
    }
...
var ApexChartComponent = /** @class */ (function () {
    ...
    ApexChartComponent.prototype.ngOnChanges = function (changes) {
        var _this = this;
        if (this.chart) {
            this.chart.destroy();
        }
